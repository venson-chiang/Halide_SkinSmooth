#ifndef HALIDE__bin___host___skinDetection_h
#define HALIDE__bin___host___skinDetection_h
#include <stdint.h>
...
int skinDetection(struct halide_buffer_t *_input_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int skinDetection_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *skinDetection_metadata();
