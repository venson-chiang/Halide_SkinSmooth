#ifndef HALIDE__bin___host___skinDenoise_h
#define HALIDE__bin___host___skinDenoise_h
#include <stdint.h>
...
int skinDenoise(struct halide_buffer_t *_input_buffer, int32_t _width, int32_t _height, int32_t _radius, int32_t _smoothLevel, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int skinDenoise_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *skinDenoise_metadata();
